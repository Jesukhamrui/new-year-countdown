...
(hh = h / 2),
  (opts = {
    ...
    strings: ["HAPPY", "BIRTHDAY!", "to You", "dear", "May all your dreams come true!"],
...
function anim() {
  ...
  heartSpawnTimer++;
  if (heartSpawnTimer >= opts.heartSpawnTime) {
  ...
  // Spawn and animate flowers
  flowerSpawnTimer++;
  if (flowerSpawnTimer >= opts.flowerSpawnTime) {
  ...
  if (done) {
    ...
    // Clear hearts and flowers when animation resets
    hearts.length = 0;
    flowers.length = 0;
    heartSpawnTimer = 0;
    flowerSpawnTimer = 0;
